  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Подборка лучших квартир в категории "{section.category.name}"
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {section.flats.slice(0, 6).map(apartment => (
                <div
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-semibold shadow-lg">
                      {new Intl.NumberFormat('ru-RU').format(apartment.flat.price)} ₽
                    </div>
      ...
      {(isAuthenticated && (role === 'ADMIN' || role === 'CONTENT_MANAGER')) && (
        <>
          {modals.pageInfo && <PageInfoEditor />}
          {modals.socialMedia && <SocialMediaEditor />}
          <HomePageManager />
        </>
      )}
    </div>
