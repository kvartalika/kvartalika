      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="mb-6">
          {apartment.flat.hasDecoration ? (
            <div className="inline-flex items-center px-4 py-2 bg-success-50 border border-success-200 rounded-xl text-success-700 font-medium">
            ...
            <div className="inline-flex items-center px-4 py-2 bg-warning-50 border border-warning-200 rounded-xl text-warning-700 font-medium">
