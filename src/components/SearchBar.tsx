          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl font-medium transition-all duration-200 flex items-center gap-2 ${
              modals.filters || anyActive
                ? 'bg-primary-600 text-surface-50 shadow-lg shadow-primary-600/25'
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 mt-4 p-6 animate-fade-in">
                ...
                {[1, 2, 3, 4].map(r => (
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                      currentSearchParams.rooms === r ? 'bg-primary-600 text-surface-50' : 'bg-surface-100 text-surface-700 hover:bg-surface-200'
                    }`}
                  >
                    {r === 4 ? '4+' : r}
                  </button>
          ...
          <div className="flex justify-end mt-6">
            <button
              ...
              className="px-6 py-2 bg-primary-600 text-surface-50 rounded-xl font-medium hover:bg-primary-700 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              Применить фильтры
            </button>
          </div>
