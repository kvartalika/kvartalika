...
export default function Scene3D({model}: Scene3DProps) {
  ...
  return (
    <div className="mx-auto p-4 w-full max-w-4xl h-[80vh] bg-gradient-to-br from-indigo-50 to-gray-100 rounded-2xl shadow-xl overflow-hidden border border-indigo-100">
      <Canvas
